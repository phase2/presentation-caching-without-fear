(function ( document, window) {
  var notes = window.open('about:blank', 'presenterNotes', 'height=400,width=400');
  notes.document.write('<html><head><title>Presenter Notes</title></head><body><div id="note"></div></body></html>')
